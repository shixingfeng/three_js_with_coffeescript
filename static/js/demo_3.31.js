...
(function() {
  ...
  init = function() {
    var ambiColor, ambientLight, cube, cubeGeometry, cubeMaterial, dirLight, directionalLight, gui, hemiLight, initStats, invert, phase, plane, planeGeometry, planeMaterial, pointColor, renderScene, sphere, sphereGeometry, sphereMaterial, spotLight0, stats, step, target, textureGrass;
    // 场景
    ...
    gui.add(controls, 'hemisphere').onChange(function(e) {
      if (!e) {
        return hemiLight.intensity = 0;
      } else {
        return hemiLight.intensity = controls.intensity;
      }
    });
    gui.addColor(controls, 'color').onChange(function(e) {
      return hemiLight.groundColor = new THREE.Color(e);
    });
    gui.addColor(controls, 'skyColor').onChange(function(e) {
      return hemiLight.color = new THREE.Color(e);
    });
    gui.add(controls, 'intensity', 0, 5).onChange(function(e) {
      return hemiLight.intensity = e;
    });
