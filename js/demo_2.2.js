...
(function() {
  ...
  init = function() {
    var addControl, ambientLight, controlPoints, f1, faces, geom, gui, i, initStats, j, materials, mesh, plane, planeGeometry, planeMaterial, renderScene, spotLight, stats, vertices;
    // 场景
