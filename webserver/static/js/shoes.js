...
(function() {
  ...
  var camera, can_move, client_x, client_y, init, mousemove_time_save, orbitControls, orbitControls_rotateLeft, orbitControls_rotateRight, orbitControls_rotate_timeout, renderer, renderer_size, scene, step, turn_left_180, turn_left_360, turn_left_90, turn_right_180, turn_right_360, turn_right_90, zero;
  ...
  init = function() {
    var add_uri, ambiLight, camera_fov, camera_x, camera_y, camera_z, clock, fov, group, loader, renderScene, spotLight, spotLight2, spotLight3;
    // 场景
  ...
  turn_left_90.addEventListener("click", function(e) {
    ...
    return console.log("左移90");
  });

  turn_right_90.addEventListener("click", function(e) {
    orbitControls_rotate(-0.025, 0);
    return console.log("右移90");
  });
