...
(function() {
  var camera, cube, group, init, onResize, renderer, scene, sphere;
  ...
  init = function() {
    var controls, createMesh, cubeFolder, ground, groundMesh, groundMesh_arr, gui, initStats, renderScene, setFromObject, sphereFolder, stats, step, webGLRenderer;
    // 场景
