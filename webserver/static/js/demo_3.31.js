...
(function() {
  ...
  init = function() {
    var camera, controls, cube, cubeGeometry, cubeMaterial, dirLight, gui, hemiLight, initStats, plane, planeGeometry, planeMaterial, pointColor, renderScene, renderer, scene, sphere, sphereGeometry, sphereMaterial, spotLight0, stats, step, target, textureGrass;
    // 场景
