...
(function() {
  var camera, init, latheMesh, onResize, renderer, scene, spGroup;
  ...
  init = function() {
    ...
    // 生成点
    generatePoints = function(segments, phiStart, phiLength) {
      var count, height, i, j, latheGeometry, material, points;
      // 随机三个数值的点
      points = [];
      height = 5;
      count = 30;
