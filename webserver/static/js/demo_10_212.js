...
(function() {
  ...
  init = function() {
    var controls, geom, gui, initStats, mat, renderScene, stats, step, texture, webGLRenderer;
    // 场景
    ...
    controls = new function() {
      this.loadCube1 = function() {
        ...
        return loader.load("/static/pictures/assets/models/UVCube1.obj", function(geometry) {
          var material;
          if (mesh) {
            scene.remove(mesh);
          }
      ...
      this.loadCube2 = function() {
        var loader;
        loader = new THREE.OBJLoader();
        return loader.load("/static/pictures/assets/models/UVCube2.obj", function(geometry) {
          var material;
          if (mesh) {
            scene.remove(mesh);
          }
