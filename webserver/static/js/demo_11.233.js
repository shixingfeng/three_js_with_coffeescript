...
(function() {
  ...
  init = function() {
    var FXAAShader, bleachFilter, composer, controls, cube, dirLight, edgeShader, effectCopy, focusShader, gui, i, initStats, j, k, l, plane, range, renderPass, renderScene, scale, spotLight, stats, step, stepX, stepZ, webGLRenderer;
    // 场景
    ...
    for (i = k = -25; k <= 4; i = ++k) {
      for (j = l = -15; l <= 14; j = ++l) {
        cube = new THREE.Mesh(new THREE.BoxGeometry(3, 4, 3), new THREE.MeshPhongMaterial({
    ...
    controls = new function() {
      ...
      this.onChange = function() {
        ...
        return focusShader.uniforms.sampleDistance.value = controls.sampleDistance;
      };
      return this;
    };
    // UI
