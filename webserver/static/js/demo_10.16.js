...
(function() {
  var camera, cubeCamera, init, onResize, renderer, scene;
  ...
  init = function() {
    var ambi, clock, control, createMesh, initStats, orbitControls, renderScene, sphere, spotLight, stats, step, webGLRenderer;
    // 场景
    ...
    createMesh = function(geom) {
      var mesh, normalTexture, planetMaterial, planetTexture, specularTexture;
