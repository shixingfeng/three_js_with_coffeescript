...
(function() {
  ...
  init = function() {
    var controls, createParticles, gui, initStats, renderScene, stats, step, webGLRenderer;
    // 场景
    ...
    //创建粒子
    createParticles = function(size, transparent, opacity, vertexColors, sizeAttenuation, color) {
    ...
    controls = new function() {
      ...
      this.redraw = function() {
        ...
        return createParticles(controls.size, controls.transparent, controls.opacity, controls.vertexColors, controls.sizeAttenuation, controls.color);
      };
      return this;
    };
    // UI
