...
(function() {
  var addControls, camera, control, createCubeMap, cubeCamera, init, onResize, orbit, renderer, scene, sphere;
  ...
  addControls = function(controlObject) {
    var gui;
    gui = new dat.GUI();
    return gui.add(controlObject, "rotationSpeed", -0.1, 0.1);
  };

  createCubeMap = function() {
    var format, path, textureCube, urls;
  ...
  init = function() {
    var boxGeometry, cube, cylinder, cylinderGeometry, dynamicEnvMaterial, envMaterial, initStats, material, renderScene, shader, skybox, sphereGeometry, stats, step, textureCube, webGLRenderer;
    // 场景
    ...
    dynamicEnvMaterial = new THREE.MeshBasicMaterial({
