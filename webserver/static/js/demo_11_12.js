...
(function() {
  ...
  init = function() {
    var ambi, bloomPass, bpFolder, clock, composer, composer1, composer2, composer3, composer4, controls, createMesh, dotScreenPass, dsFolder, effectCopy, effectFilm, fpFolder, gui, halfHeight, halfWidth, height, initStats, orbitControls, renderPass, renderScene, sphere, spotLight, stats, step, webGLRenderer, width;
    // 场景
    ...
    controls = new function() {
      ...
      this.updateDotScreen = function() {
        ...
        composer1.addPass(renderScene);
        composer1.addPass(dotScreenPass);
        return composer1.addPass(effectCopy);
      };
      this.updateEffectBloom = function() {
        ...
        composer3.addPass(renderScene);
        composer3.addPass(bloomPass);
        return composer3.addPass(effectCopy);
      };
      return this;
    };
    // UI
