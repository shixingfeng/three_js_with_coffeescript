...
(function() {
  ...
  init = function() {
    var composer, controls, cube, dirLight, effectCopy, gui, hBlur, hTilt, i, initStats, j, k, l, plane, range, renderPass, renderScene, scale, spotLight, stats, step, stepX, stepZ, tri, vBlur, vTilt, webGLRenderer;
    // 场景
    ...
    controls = new function() {
      ...
      this.onChange = function() {
        ...
        return tri.uniforms.delta.value = new THREE.Vector2(controls.deltaX, controls.deltaY);
      };
      return this;
    };
    // UI
