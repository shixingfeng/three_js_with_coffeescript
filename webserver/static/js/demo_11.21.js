...
(function() {
  ...
  init = function() {
    var ambi, ambi2, bgPass, bgPlane, cameraBG, clearMask, clock, composer, controls, createEarthMesh, createMarshMesh, earthMask, effectColorify, effectCopy, effectSepia, gui, initStats, marsMask, materialColor, orbitControls, renderPass, renderPass2, renderScene, sceneBG, sceneEarth, sceneMars, sphere, sphere2, spotLight, spotLight2, stats, step, webGLRenderer;
    // 场景
    ...
    // 方法
    createMarshMesh = function(geom) {
      var normalTexture, planetMaterial, planetTexture;
