...
(function() {
  ...
  console.log("demo_2.12 场景雾化效果");

  console.log("新内容：材质覆盖overridematerial");
  ...
  init = function() {
    var ambientLight, controls, gui, initStats, plane, planeGeometry, planeMaterial, renderScene, spotLight, stats;
