...
(function() {
  ...
  init = function() {
    var ambientLight, controls, createMaterial, cube, cubeGeometry, initStats, material, meshMaterial1, meshMaterial2, meshMaterial3, meshMaterial4, meshMaterial5, meshMaterial6, renderScene, spotLight, stats, step;
    // 场景
    ...
    // 创建材质
    createMaterial = function(vertexShader, fragmentShader) {
      var attributes, fragShader, meshMaterial, uniforms, vertShader;
    ...
    material = new THREE.MeshFaceMaterial([meshMaterial1, meshMaterial2, meshMaterial3, meshMaterial4, meshMaterial5, meshMaterial6]);
    ...
    renderScene = function() {
      ...
      cube.material.materials.forEach(function(e) {
        return e.uniforms.time.value += 0.01;
      });
