...
(function() {
  ...
  init = function() {
    var ambientLight, contX, contY, contZ, controls, cube, geom, gui, guiPosition, guiRotation, guiScale, guiTranslate, initStats, material, plane, planeGeometry, planeMaterial, renderScene, scene, spotLight, stats;
    // 场景
    ...
    controls = new function() {
      ...
      this.translate = function() {
        ...
        return controls.positionZ = cube.position.z;
      };
      return this;
    };
    gui = new dat.GUI();
    ...
    contX.onChange(function(value) {
      return cube.position.x = controls.positionX;
    });
    contY.onChange(function(value) {
      return cube.position.y = controls.positionY;
    });
    contZ.onChange(function(value) {
      return cube.position.z = controls.positionZ;
    });
