...
(function() {
  ...
  init = function() {
    var ambientLight, clock, controls, flyControls, gui, initStats, load, loader, renderScene, setCamControls, setRandomColors, spotLight, stats, step, texture, webGLRenderer;
    // 场景
