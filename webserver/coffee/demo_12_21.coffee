...
initScene = ()->
    ...
    # 材质
    ground_material = Physijs.createMaterial new THREE.MeshPhongMaterial({map: THREE.ImageUtils.loadTexture("/static/pictures/assets/textures/general/floor-wood.jpg")}),.9,.6 
