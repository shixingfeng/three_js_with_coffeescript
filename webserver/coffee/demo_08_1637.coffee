console.log "demo_8.37  Load babylon model"
camera = null
scene = null
renderer = null
mesh = null
...
init = ()->
    ...
    camera.lookAt new THREE.Vector3 10, 20, 20
    ...
    add_uri = "/static/pictures/assets/models/babylon/"
    loader.load add_uri+"skull.babylon", (loadedScene)->
